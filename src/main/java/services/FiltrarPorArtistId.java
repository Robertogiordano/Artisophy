...
@WebServlet("/FilterArtistById")
public class FiltrarPorArtistId extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException{
		...
		try {
			artElementsList = ConsultasBBDD.filterArtElementId(ArtElementType.ARTISTS,id);

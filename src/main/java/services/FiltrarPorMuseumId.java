/*used to connect museum to artwork*/
...
@WebServlet("/FilterMuseumById")
public class FiltrarPorMuseumId extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException{
		...
		try {
			artElementsList = ConsultasBBDD.filterArtElementId(ArtElementType.MUSEUMS,id);

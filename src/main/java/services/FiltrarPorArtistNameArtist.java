...
@WebServlet("/FilterArtistByNameArtist")
public class FiltrarPorArtistNameArtist extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException{
		...
		try {
			...
			artElementsList = ConsultasBBDD.filterArtElement(ArtElementType.ARTISTS,"name_artist LIKE '%"+name+"%'");

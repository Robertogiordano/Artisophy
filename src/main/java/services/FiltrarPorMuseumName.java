...
@WebServlet("/FiltrarPorMuseumName")
public class FiltrarPorMuseumName extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)throws ServletException{
		...
		try {
			...
			artElementsList = ConsultasBBDD.filterArtElement(ArtElementType.MUSEUMS,"name LIKE '%"+name+"%'");
